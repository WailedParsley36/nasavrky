      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-primary mb-12">
            Vybrané stavební parcely
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {AllParcels.filter((x) => !x.prodano)
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">
                Zasazené v malebném prostředí, Nasavrky nabízejí dokonalou
                rovnováhu mezi venkovským klidem a moderním pohodlím.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">
                Připojte se k naší přátelské komunitě s výbornými školami,
                místními službami a pravidelnými kulturními akcemi.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">
                Užijte si klidný venkovský život s pohodlným spojením do větších
                městských center.
              </p>
            </div>
          </div>
